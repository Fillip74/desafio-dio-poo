...
public class Bootcamp {
	...
	public void adicionarCurso(Conteudo conteudo) {
		if (!this.conteudos.contains(conteudo)) {
			this.conteudos.add(conteudo);
		} else {
			System.err.println("Você ja está inscrito nesse curso/mentoria: " + conteudo.getTitulo());
		}
	}

	public void removerCurso(Conteudo conteudo) {
		if (this.conteudos.contains(conteudo)) {
			this.conteudos.remove(conteudo);
		} else {
			System.err.println("Você não está inscrito nesse curso/mentoria: " + conteudo.getTitulo());
		}
	}
